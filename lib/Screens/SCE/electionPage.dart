      ...
      child: Column(
        children: [
          Row(
            children: [
              const Padding(
                padding: EdgeInsets.only(top: 85.0, left: 50.0),
              ),
              DefaultTextStyle(
                style: TextStyle(
                  fontSize: 30.0,
                   ...
                   const SizedBox(height: 20.0),
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                            padding: EdgeInsets.only(left: 60.0, top: 60.0)),
                        Container(
                          width: 350.0,
                          height: 45.0,
                          child: TextField(
                    ...
                    Row(
                      children: [
                        ...
                        const Padding(
                            padding: EdgeInsets.only(left: 59.0, top: 55.0)),
                        Container(
                          width: 350.0,
                          height: 45.0,
                          child: TextField(
                      ...
                      child: FlatButton.icon(
                        onPressed: () {
                          Navigator.push(context,
                              MaterialPageRoute(builder: (_) => ShsResult()));
                        },
                        icon: Icon(
                          Icons.list,
                          size: 40.0,
