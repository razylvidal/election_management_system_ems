  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(padding: EdgeInsets.only(left: 250, right: 250),
        child: Column(
                ...
                Expanded(
                  child: Container(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('First Name:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500),),
                       Container(
                              //width: 200,
                              height: 40,
                              child: TextField(
                ...
                Expanded(
                  child: Container(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Middle Name:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500,)),
                       Container(
                              //width: 200,
                              height: 40,
                              child: TextField(
                ...
                Expanded(
                  child: Container(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Last Name:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500,)),
                       Container(
                              //width: 200,
                              height: 40,
                              child: TextField(
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                       Text('Grade Level:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500,)),
                       GradeLevel(),
                       SizedBox(height: 15,)
                    ],
                  )
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                       Text('Position:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500,)),
                       Position()
                    ],
                  )
                ),
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                       Text('Partylist:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500,)),
                       Partylist()
                    ],
                  )
                ),
...
class _EmailState extends State<Email> {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Email Address:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500,)),        
        Container(
            height: 50,
            child: TextField(
        ...
        Text(_errorMessage, style: TextStyle(color: Colors.red, fontSize: 15),)
      ]
    );
  }
